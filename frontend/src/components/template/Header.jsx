...
import logoPiagam from '../../images/assets/logo-piagam.png'
import logoPiagamTransparent from '../../images/assets/logo-piagam2.png'
import {
      ...
      <div className="header-content">
        <div className="header-left">
          ...
          <div className="header-brand">
            <img src={logoPiagam} alt="Logo" className="header-brand-logo" />
          </div>
        </div>

        <div className="header-right" style={{ position: 'relative', overflow: 'hidden' }}>
          <img
            src={logoPiagamTransparent}
            alt=""
            aria-hidden="true"
          ...
          />
          <span className="header-brand-title" style={{ position: 'relative', zIndex: 1 }}>
            {title}
          </span>
        </div>
      </div>
